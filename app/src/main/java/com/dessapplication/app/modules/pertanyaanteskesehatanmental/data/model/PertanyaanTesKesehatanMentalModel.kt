package com.dessapplication.app.modules.pertanyaanteskesehatanmental.`data`.model

import com.dessapplication.app.R
import com.dessapplication.app.appcomponents.di.MyApp
import kotlin.String

data class PertanyaanTesKesehatanMentalModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTime: String? = MyApp.getInstance().resources.getString(R.string.msg_dalam_4_minggu)
